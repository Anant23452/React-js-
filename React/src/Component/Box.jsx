...
function Box({users}) {
 ...
 {users.map((elem,index)=>{
       <div key={index} className='w-[16vw] h-[45vh] bg-zinc-300 flex flex-col justify-start items-center gap-5 rounded-md text-black '>
        <div className="image w-[2vw] h-5 rounded-full bg-blue-700  text-black"> </div>
            <h1 className='text-center ' >elem.name </h1>
            <p className="text-xs opacity-50 ">elem.email </p>

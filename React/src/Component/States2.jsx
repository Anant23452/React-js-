...
function States2() {
  // const [val,setVal]=useState({name:"anant",age :24});
  ...
  return (
    ...
    <button onClick={()=>{setVal(()=>val.map(item=>item.name==="ajit"?({name:"ajit",age:26}):item))}} className="p-2 m-2 bg-blue-600 rounded-full text-white">Remove</button>
